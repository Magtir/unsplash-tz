...
// Load the index-page.html file containing referances to your application bundle.
...
ROUTES.forEach((route) => {
  ...
  // Writes rendered HTML to index-page.html, replacing the file if it already exists.
